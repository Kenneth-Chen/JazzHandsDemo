...
if (cameraObject.transform.position.x == 5){

cameraObject.transform.position = Vector3(0, 0, 0);
}else{
cameraObject.transform.position = Vector3(5, 0, 0);
}
...
if (directionVector != Vector3.zero) {
	...
	if(jumpcommand==1){
		//inputJump=true;
		cameraObject.transform.Translate(5,0,0);
		jumpcommand=0;
		}
